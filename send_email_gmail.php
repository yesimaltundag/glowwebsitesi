...
// Basit mail() fonksiyonu (yedek)
function sendEmailSimple($to, $subject, $message, $from_name = "GLOW Sitesi") {
    $headers = array(
        'MIME-Version: 1.0',
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    // Önce Gmail SMTP dene, başarısız olursa basit mail() kullan
    $result = sendEmailGmail($email, $subject, $message);
    
    if (!$result) {
        // Gmail başarısız olursa basit mail() dene
        $result = sendEmailSimple($email, $subject, $message);
    }
