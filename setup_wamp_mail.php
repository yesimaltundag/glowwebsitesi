...
echo "<h2>🔧 WAMP Mail Ayarları Kurulumu</h2>";
...
echo "<h3>⚙️ Ayarları Değiştiriyorum...</h3>";

// Mail ayarlarını runtime'da değiştir
...
$subject = "GLOW - Mail Testi";
$message = "Bu bir test e-postasıdır. WAMP mail ayarları çalışıyor!";
...
<body>
    <div class='container'>
        <div class='header'>
            <h2>🧪 GLOW - Mail Testi</h2>
        </div>
        <div class='content'>
            <p>Merhaba,</p>
            <p>Bu bir test e-postasıdır. WAMP mail ayarları çalışıyor!</p>
...
echo "<p><a href='test_email.php' target='_blank'>📧 E-posta Test Sayfası</a></p>";
